...
- [x] UX-M10 (protección) · Respawn expuesto sin invulnerabilidad. **HECHO (97901f0):** 2s de protección en spawnPlayerInBuilding (solo combate) → `damageDrone` skip mientras `spawnProtected` (pura); rompe al disparar (anti-exploit); victim-authoritative. _(UX-M10b: spawn más SEGURO —lejos de enemigos— pendiente.)_
